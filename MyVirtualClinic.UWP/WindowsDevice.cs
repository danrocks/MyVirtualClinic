...
#else
            //djk get { return _mediaPicker ?? (_mediaPicker = Resolver.Resolve<IMediaPicker>()); }
            get { return _mediaPicker ?? (_mediaPicker = Resolver.Resolve<IMediaPicker>() ?? new MyVirtualClinic.UWP.MediaPicker()); }
#endif
