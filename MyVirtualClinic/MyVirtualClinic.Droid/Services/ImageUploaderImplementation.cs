...
[assembly: Xamarin.Forms.Dependency(typeof(MyVirtualClinic.Droid.ImageUploaderImplementation))]
namespace MyVirtualClinic.Droid
{
    class ImageUploaderImplementation : AbstractImageUploaderImplementation
    {
        ...
        private async Task<HttpClient> GetHttpClient(bool login)
        {
            ...
            HttpClientHandler han = new HttpClientHandler();
            var client = new HttpClient(han);
